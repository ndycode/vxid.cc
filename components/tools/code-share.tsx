...
import { Copy, Check, Code, CaretDown, Lock, Eye, EyeSlash } from "@phosphor-icons/react";
import { Input } from "@/components/ui/input";
import { EXPIRY_OPTIONS, CODE_LANGUAGES } from "@/lib/share-types";
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center">
                            <Code weight="duotone" className="w-5 h-5 text-primary" />
                        </div>
                        <div className="flex-1 min-w-0">
                            <p className="font-semibold">Code shared!</p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-1 flex-wrap">
                        {CODE_LANGUAGES.slice(0, 8).map((lang) => (
                            <button
                                ...
                                className={`px-2 py-1 text-xs rounded-lg ${language === lang.id
                    ...
                    <div className="space-y-1">
                        <textarea
                            ...
                            className="w-full h-36 px-3 py-2 text-sm font-mono bg-muted/50 border rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-primary/50"
                        />
                        {content && (
                        ...
                        {showOptions && (
                            ...
                            >
                                <div className="space-y-1">
                                    ...
                                    <div className="flex gap-1 flex-wrap">
                                        {CODE_LANGUAGES.slice(8).map((lang) => (
                                            <button
                                                key={lang.id}
                                                onClick={() => setLanguage(lang.id)}
                                                className={`px-2 py-1 text-xs rounded-lg ${language === lang.id
